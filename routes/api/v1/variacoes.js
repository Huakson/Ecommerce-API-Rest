...
router.get("/", validate(VariacaoValidation.index, {}, {}), variacaoController.index); // testado
router.get("/:id", validate(VariacaoValidation.show, {}, {}), variacaoController.show); // testado

router.post("/", auth.required, LojaValidation.admin, validate(VariacaoValidation.store, {}, {}), variacaoController.store); // testado
